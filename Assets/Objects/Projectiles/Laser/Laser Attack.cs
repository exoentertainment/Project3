...
public class LaserAttack : MonoBehaviour
{
    ...
    public float beamLength; //Ingame beam length
    ...
    void FixedUpdate()
	{
		if (beam) 
		{
			...
			if (beamCollides && Physics.Raycast(transform.position, transform.forward, out hit, beamLength,laserProjectileSO.targetLayer))
			{
