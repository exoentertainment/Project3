...
public class ProbeTurretAttack : MonoBehaviour
{
    #region -- Serialized Fields --

    [Header("Scriptable Object")]
    [SerializeField] ProbeTurretScriptableObject turretSO;
    ...
    {
        if (target == null || Vector3.Distance(barrelTransform.position, target.transform.position) > turretSO.attackRange)
        {
